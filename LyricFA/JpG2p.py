...
class JpG2p:
    ...
    def kana_to_romaji(self, kana_list, double_written_sokuon=False):
        ...
        #
        aoyin_list = ['ゃ','ゅ','ょ']
        separate_kana_list = [kana for kana_word in input_list for kana in kana_word]
        input_list = separate_kana_list
        i = 0
        result = []
        while i < len(input_list):
            if input_list[i] in aoyin_list:
                merged_str = input_list[i-1] + input_list[i]
